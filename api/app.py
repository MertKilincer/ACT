...
async def predict(file: UploadFile = File(...)):
    try:
        ...
        image.save("image/" + file.filename)
        prediction = predict_image("image/"+file.filename, "models/best_mlp_model.joblib", "models/label_encoder.joblib")
        ...
        return JSONResponse(status_code=500, content={"error": "anan hata cikti"})
